...
const content = {
  ...
  uk: {
    ...
    introText2: " понад усе. Вони — наша основа, наш найважливіший ресурс, значущість якого неможливо переоцінити.",
    introText3: "Тому ми завжди раді отримувати повідомлення ",
    introHighlight2: "талановитих спеціалістів",
    introText4: ", навіть якщо наразі немає відкритої вакансії.",
    introText5: "Залиште свої контактні дані та кілька слів про себе та ",
    ...
    messagePlaceholder:
      "Розкажіть трохи про свій досвід: скільки часу ви працюєте у цій сфері, чому обрали її і що вас надихає. Формальності не потрібні — нам просто хочеться вас краще пізнати.",
