        ...
        <div className="md:hidden space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <p className="text-xs font-medium text-[#212121]">
                We are <span className="text-[#FF6200]">structured</span>
              </p>
            </div>
            ...
            >
              ...
              <p className="text-xs font-medium text-[#212121]">
                We don't <span className="text-[#FF6200]">hide our rates</span>
              </p>
            </div>
            ...
            >
              ...
              <p className="text-xs font-medium text-[#212121]">
                We're keen on <span className="text-[#FF6200]">technologies</span>
              </p>
            </div>
            ...
            >
              ...
              <p className="text-xs font-medium text-[#212121]">
                We take full <span className="text-[#FF6200]">responsibility</span>
              </p>
            </div>
          </div>
          ...
          >
            ...
            <p className="text-sm font-medium text-[#212121] leading-relaxed">
              We are completely transparent in communication and always by your side to{" "}
              <span className="text-[#FF6200]">maximize</span> the efficiency of implementing{" "}
              <span className="text-[#FF6200]">your idea</span>
            </p>
          </div>
