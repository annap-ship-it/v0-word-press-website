  ...
  return (
    <>
      {isVisible && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-15 right-8 z-40 w-11 h-11 rounded-full flex items-center justify-center transition-all duration-300 hover:opacity-80 hover:shadow-[0_0_12px_rgba(255,98,0,0.6)] animate-fade-in"
          style={{
